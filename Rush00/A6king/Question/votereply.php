    ...
    // check if the user has already clicked on the unlike (rate = 2) or the like (rate = 1)
        ...
        $rate_like_count = $bdd->prepare('SELECT COUNT(*) FROM rate_rep WHERE id_item = :pageID and rate = 1');
        ...
        $rate_dislike_count = $bdd->prepare('SELECT COUNT(*) FROM rate_rep WHERE id_item = :pageID and rate = 2');
